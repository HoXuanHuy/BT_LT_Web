				...
				<ul class="list-unstyled list-inline pull-right">
					<c:choose>
						<c:when test="${not empty sessionScope.account}">
							<li><a href="/ltwebhxh/views/Multipart.jsp">My Account</a></li>
	                        <li><a href="shop-wishlist.html">My Wishlist</a></li>
	                        <li><a href="shop-checkout.html">Checkout</a></li>
	                        <a>Xin chào, ${sessionScope['account'].fullname}!</a>
	                        <li><a href="${pageContext.request.contextPath}/logout">Log Out</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/ltwebhxh/views/signup.jsp">Sign up</a></li>
	                        <li><a href="/ltwebhxh/views/login.jsp">Log In</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
...
<div class="header">
	<div class="container">
		<a class="site-logo" href="/ltwebhxh/home"><img
